...
ExecStart=/home/kadena-miner/chainweb-miner gpu \$NODES --miner-key \$PUBLIC_KEY --miner-account \$PUBLIC_KEY --log-level debug \$CHAIN --miner-path /home/kadena-miner/BigOlChungus/bigolchungus.sh --miner-args "-d %I"
Restart=always
RestartSec=3
